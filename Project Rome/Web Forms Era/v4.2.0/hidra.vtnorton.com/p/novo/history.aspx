<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="history.aspx.cs" Inherits="HidraOnline.p.novo.history" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        ...
        <li><a class="on" href="/p/novo/history.aspx">Nova história</a></li>
