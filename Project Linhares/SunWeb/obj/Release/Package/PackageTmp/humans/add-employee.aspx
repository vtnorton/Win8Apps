<%@ Page Title="Adicionar novo funcionário" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="add-employee.aspx.cs" Inherits="SunWeb.humans.add_employee" EnableEventValidation="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="row" style="margin-top: -20px">
            <div class="col s12">
                <div class="input-field col s3">
                    <asp:TextBox ID="txtBrazilCDTNumber" OnTextChanged="txtBrazilCDTNumber_TextChanged" AutoPostBack="true" length="10" MaxLength="10" CssClass="validate" runat="server"></asp:TextBox>
                    <label for="txtBrazilCDTNumber">Carteira de trabalho</label>
                </div>
                <div class="input-field col s2">
                    <asp:TextBox ID="txtBrazilCDTEmitionDate" length="10" MaxLength="10" CssClass="validate" runat="server"></asp:TextBox>
                    <label for="txtBrazilCDTEmitionDate">Data de emissão</label>
                </div>
                <div class="input-field col s1">
                    <asp:TextBox ID="txtBrazilCDTSigla" length="2" MaxLength="2" CssClass="validate" runat="server"></asp:TextBox>
                    <label for="txtBrazilCDTSigla">UF</label>
                </div>
                <div class="input-field col s1">
                ...
                <div class="input-field col s3">
                    <asp:TextBox ID="txtBrazilCDTPIS" length="14" MaxLength="14" CssClass="validate" runat="server"></asp:TextBox>
        ...
        <div class="row">
            <div class="col s12">
                ...
                <div class="input-field col s4">
                    <asp:TextBox ID="txtBrazilCNH" OnTextChanged="txtBrazilCNH_TextChanged" AutoPostBack="true" length="50" CssClass="validate" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col col-md-4">
                <div class="all-post text-center">
                    <asp:LinkButton CssClass="btn btn-transparent" ID="hplAdd" OnClick="hplAdd_Click" runat="server"><i class="fa fa-plus"></i>Adicionar funcionário</asp:LinkButton>
                </div>
            </div>
            <div class="col col-md-4">
                <div class="all-post text-center">
                    <asp:LinkButton CssClass="btn btn-transparent" ID="hplAddUser" OnClick="hplAddUser_Click" runat="server"><i class="fa fa-plus"></i>Criar usuário</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
