<%@ Page Title="Gerenciar clientes | AgroAssistant" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="manage-client.aspx.cs" Inherits="SunWeb.humans.manage_client" %>
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <div class="wrap-about kill-margin-bottom">
                        ...
                        <div class="about-content text-center">
                            <h3>Interações com clientes</h3>
                            <p>Lorem ipsum dolor sit amet, duo nostrum corrumpit ne, id nam quem diam, vel ut justo soleat reformidans.</p>
                        </div>
                    </div>
                    <div class="all-post text-center">
                        <a class="btn btn-transparent" href="#view">Nova interação</a>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="wrap-about">
                    ...
                    <div class="all-post text-center">
                        <a class="btn btn-transparent" href="add-client.aspx">Novo cliente</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="post-pagination">
            ...
            <div class="right">
                <ul class="table-filter">
                    ...
                    <li><a href="add-client.aspx"><i class="fa fa-plus" style="margin-right: 0 !important;"></i></a></li>
                </ul>
            </div>
            <div class="clean"></div>
        </div>
                ...
                <ItemTemplate>
                    <tr class="dark" id="employee<%#Eval("Id") %>">
                        ...
                        <td style="min-width:108px; max-width: 108px; width:108px !important">
                            <asp:LinkButton ID="delete" CommandArgument='<%#Eval("Id") %>' style="margin-right: -10px; color: #ff0000" title="Deletar cliente" OnCommand="delete_Command" runat="server"><i class="fa fa-trash-o"></i></asp:LinkButton>
                            <a href="edit-client.aspx?Id=<%#Eval("Id") %>" style="margin-right: -10px; color: #15992A" title="Editar cliente">
                    ...
                    <tr id="openEmployee2<%#Eval("Id") %>" style="display: none">
                        <!-- Adicionar interações com os clientes -->
                    ...
                    <tr id="openEmployee<%#Eval("Id") %>" style="display: none">
                        ...
                        <td style="max-width: 51px; min-width: 51px; margin-left: 3px;">
                            <a href="edit-client.aspx?Id=<%#Eval("Id") %>" title="Editar" style="color: #15992A; position: relative; top: -6px; left: 3px">Editar <i class="fa fa-plus" style="margin-left: 15px; margin-right: 0"></i>
                            </a>
                        </td>
                    </tr>
                </ItemTemplate>
