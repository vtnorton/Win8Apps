        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            if (txtInvalidSpam.Text != null)
            {
                if (txtEmail.Text != null)
                {
                    ...
                    {
                        Read bug = new Read();
                        Ladon.Methods.Create newSugestion = new Ladon.Methods.Create();
                        bool Worked = newSugestion.NewSugestion("Não recebido", txtEmail.Text, txtMensagem.Text, "vtnorton.com");
                        if (Worked)
                        {
                            if (!ckbNotSendEmail.Checked)
                            {
                                ...
                                Message.Body = string.Concat(BodyPt.StartSendFoward, "<br />E-mail: ", txtEmail.Text, "<br /><br /><br />Mensagem: ", Strings.JustFistUppercase(txtMensagem.Text), BodyPt.End);
