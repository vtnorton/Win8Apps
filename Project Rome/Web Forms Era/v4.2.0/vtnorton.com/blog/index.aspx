<%@ Page Title="Blog | Vítor Norton" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="VTNORTON.blog.index" %>
                ...
                <ItemTemplate>
                    <div class="lp-stand-alone">
                        ...
                        <div class="right lpsa-post">
                            ...
                            <h6>Data: <%#Eval("PostedDate") %> | Autor: <a href="/blog/author.aspx?id=<%#Eval("IdAuthor") %>"><%#Eval("AuthorName") %></a> | Categoria: <a href="/blog/categoria.aspx?id=<%#Eval("IdCategory")%>"><%#Eval("CategoryName") %></a></h6>
