...
namespace Vtnorton.Controllers
{
    public class TalksController : Controller
    {
        ...
        public IActionResult FormulaBeta(Emails mail)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    NewsletterBuilder.Insert(mail, _env);
                    Message x = new Message();
                    x.Content = "New request for Formula beta tester: " + mail.Email + "<br/>This is how they found out Formula: " + mail?.Observation;
                    x.EmailTo = "contato@vtnorton.com";
        ...
        [Route("/formula-schools/")]
        public IActionResult FormulaSchools()
        {
            return View();
        }
        ...
        [HttpPost]
        [Route("/formula-schools/")]
        public IActionResult FormulaSchools(Emails mail)
        {
            ///TODO: Corrigir isso daqui
            mail.ListID = 3;
