<%@ Page Title="Posts da categoria deletada" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="postbycategory.aspx.cs" Inherits="HidraOnline.p.manage.postbycategory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    <div class="seventyfivepercent left">
        <div class="toggle-options-head">Posts da categoria deletada</div>
        <hr />
        <table>
            <tr>
                <td>Título</td>
    ...
    <div class="twentyfivepercent right sidebar">
        ...
        <hr />
        <p>Veja, edite e gerencie os posts publicados no site da categoria recem deletada.</p>
        ...
        <br />
        <p><strong>
            <asp:Label ID="lblFiltroSelecionado" runat="server" Text=""></asp:Label></strong></p>
