<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="faq.aspx.cs" Inherits="VTNORTON.connect.faq" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Perguntas frequentes | Tenha seu site | VTNORTON</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul style="margin-left: 0;">
        ...
        <li><a class="ativo" href="faq.aspx?=submenu">Perguntas Frequentes</a></li>
    </ul>
</asp:Content>
