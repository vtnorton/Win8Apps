<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="application.aspx.cs" Inherits="HidraOnline.p.manage.application" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        <li><a href="/p/novo/application.aspx">Cadastrar aplicativo</a></li>
        <li><a class="on" href="/p/manage/application.aspx">Gerenciar aplicativos</a></li>
    </ul>
</asp:Content>
