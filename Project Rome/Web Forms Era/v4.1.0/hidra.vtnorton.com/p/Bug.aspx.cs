        ...
        protected void btnEnivar_Click(object sender, EventArgs e)
        {
            if (txtEmail.Text != null)
            {
                if (txtDescricao.Text != null)
                {
                    ...
                    bool Worked = newBug.NewBug("NonRecived", txtEmail.Text, "In page: " + Page + " - " + txtDescricao.Text, "hidra.vtnorton.com");
                    if (Worked)
                    {
                        ...
                        Message.Body = string.Concat(BodyPt.StartSendFoward, "<br />E-mail: ", txtEmail.Text, "<br /><br /><br />Mensagem: ", Strings.FistUppercase(txtDescricao.Text), BodyPt.End);
