<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="season.aspx.cs" Inherits="HidraOnline.p.novo.season" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        <li><a href="/p/novo/chapter.aspx">Novo capítulo</a></li>
        <li><a class="on" href="/p/novo/season.aspx">Nova temporada</a></li>
