...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSubMenu" runat="server">
    <ul>
        ...
        <li><a href="http://dev.vtnorton.com/released-formula-v2-0-see-whats-new/">A versão 2.0 do Formula - Universal Code Editor foi lançada</a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="bg-light">
        <div class="section-image-right">
            <div class="mainpage-mos">
                <div class="centered clearfix content-mos">
                    <!-- Tile 10: Formula -->
                    <a href="/formula" target="_blank" class="all tile-click blog empresas">
                        <div class="tile large">
                            <img class="live-img" src="images/Quebec.png" alt="Garoto de programa" />
                        </div>
                    </a>
                    <!-- Tile 11: Random 42 -->
                    <a href="/random42" target="_blank" class="all tile-click blog empresas">
                        <div class="tile small">
                            <img class="live-img" src="images/Nice.png" alt="Garoto de programa" />
                        </div>
                    </a>
                    <!-- Tile 12: Conjugar -->
                    <a href="/conjugar" target="_blank" class="all tile-click blog empresas">
                        <div class="tile small">
                            <img class="live-img" src="images/Douai.png" alt="Garoto de programa" />
                        </div>
                    </a>
                    <!-- Tile 13: Time Calculator -->
                    <a href="/timecalculator" target="_blank" class="all tile-click blog empresas">
                        <div class="tile small">
                            <img class="live-img" src="images/Lyon.png" alt="Garoto de programa" />
                        </div>
                    </a>
                    <!-- Tile 14: TrueOrDare -->
                    <a href="/verdadeouconsequencia" target="_blank" class="all tile-click blog empresas">
                        <div class="tile small">
                            <img class="live-img" src="images/LasVegas.png" alt="Garoto de programa" />
                        </div>
                    </a>
                    <!-- Tile 15: Tocha -->
                    <a href="/tochaolimpica" target="_blank" class="all tile-click blog empresas">
                        <div class="tile small">
    ...
    <section id="email" class="section-bg">
        <div class="wrapper">
            <div class="section-content-right">
                ...
                <p class="white">Se inscreva na minha newsletter e saiba tudo o que está acontecendo em primeira mão!</p>
                <p class="white">Eu odeio spam na minha caixa de e-mail, tanto quanto você. Pode assinar sem medo!</p>
                <br />
                <form runat="server">
    ...
    <section>
        <div class="wrapper" style="padding: 30px 0">
            <h2 class="blue">Blog do Norton</h2>
            <hr />
            <br />
    ...
    <section class="bg-light">
        <div class="wrapper" style="padding: 30px 0">
            <h2 class="blue">Desenvolvimento</h2>
            <hr />
            <br />
