<%@ Page Title="Editar usuário" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="edit-user.aspx.cs" Inherits="HidraOnline.p.gdvw.edit_user" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="clean"></div>
    <asp:Button ID="btnCreate" OnClick="btnCreate_Click" runat="server" Text="Atualizar autor" />
</asp:Content>
