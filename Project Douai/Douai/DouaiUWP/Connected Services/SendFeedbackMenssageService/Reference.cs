...
// 
// This code was auto-generated by Microsoft.VisualStudio.ServiceReference.Platforms, version 15.0.26206.0
// 
namespace DouaiUWP.SendFeedbackMenssageService {
    ...
    public interface FeedbackSoap {
        ...
        System.Threading.Tasks.Task<DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailResponse> SendFeedbackEmailAsync(DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequest request);
    }
    ...
    public partial class SendFeedbackEmailRequest {
        ...
        public DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequestBody Body;
        
        public SendFeedbackEmailRequest() {
        }
        
        public SendFeedbackEmailRequest(DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendFeedbackEmailResponse {
        ...
        public DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailResponseBody Body;
        
        public SendFeedbackEmailResponse() {
        }
        
        public SendFeedbackEmailResponse(DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface FeedbackSoapChannel : DouaiUWP.SendFeedbackMenssageService.FeedbackSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FeedbackSoapClient : System.ServiceModel.ClientBase<DouaiUWP.SendFeedbackMenssageService.FeedbackSoap>, DouaiUWP.SendFeedbackMenssageService.FeedbackSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailResponse> DouaiUWP.SendFeedbackMenssageService.FeedbackSoap.SendFeedbackEmailAsync(DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequest request) {
            return base.Channel.SendFeedbackEmailAsync(request);
        }
        
        public System.Threading.Tasks.Task<DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailResponse> SendFeedbackEmailAsync(string xProject, string xMenssage, string xMail, string xSubject) {
            DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequest inValue = new DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequest();
            inValue.Body = new DouaiUWP.SendFeedbackMenssageService.SendFeedbackEmailRequestBody();
            inValue.Body.xProject = xProject;
            inValue.Body.xMenssage = xMenssage;
            inValue.Body.xMail = xMail;
            inValue.Body.xSubject = xSubject;
            return ((DouaiUWP.SendFeedbackMenssageService.FeedbackSoap)(this)).SendFeedbackEmailAsync(inValue);
        }
