<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="VTNORTON.onenote.index" %>
...
<head>
    ...
    <link rel="shortcut icon" href="/onenote/img/favicon.ico" type="image/x-icon">
    <link rel="icon" href="/onenote/img/favicon.ico" type="image/x-icon">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#Subscribe">Baixar</a></li>
                    <li><a href="#Subscribe" class="button">Baixar agora</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="social">
                        <ul>
                            <li class="slide-right"><a href="https://twitter.com/vt_norton/" target="_blank"><i class="fa fa-twitter"></i></a></li>
                            <li class="slide-right"><a href="https://www.facebook.com/vitor.norton/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                            <li class="slide-right"><a href="https://instagram.com/vt_norton/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                            <li class="slide-right"><a href="https://github.com/vtnorton/" target="_blank"><i class="fa fa-github"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container" id="prebaixar">
            ...
            <form runat="server">
                <div style="margin-bottom: 22px; margin-top: 20px">
                    <asp:TextBox ID="txtEmail" MaxLength="120" CssClass="slide-bottom form-control" placeholer="Email" runat="server" TextMode="Email"></asp:TextBox>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <ul class="social">
                        <li><a href="https://twitter.com/vt_norton/" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="https://www.facebook.com/vitor.norton/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://instagram.com/vt_norton/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="https://github.com/vtnorton/" target="_blank"><i class="fa fa-github"></i></a></li>
                    </ul>
                    <small>&copy; Copyright. Todos os direitos reservados. <a href="http://vtnorton.com" target="_blank">Vítor Norton</a></small>
                </div>
            </div>
        </div>
    </footer>
