...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        setInterval(function () {
            var hoje = new Date();
            var futuro = new Date('2015', '09', '16', '20', '30', '00');
...
<asp:Content ID="Content3" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        ...
        <li><a href="/clock">E quando chegar a zero?</a></li>
        <li><a href="#">Invista em mim!</a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="clock parallax">
        <h2 style="margin-bottom: 20px">você não perde por esperar</h2>
    ...
    <div class="home">
        <div class="home-1">
            <img src="images/others/clock.jpg" style="width: 100%" alt="16 de Outubro, você não perde por esperar" title="16 de Outubro, você não perde por esperar" />
            <article>
