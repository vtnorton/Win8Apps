<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="VTNORTON.index" %>
...
<head runat="server">
    ...
    <meta name="description" content="vNext.com.br, yapp.vtnorton.com e um monte de outras coisas que eu faço." />
    <meta name="keywords" content="design, desenvolvimento, windows phone, windows, vitor norton, kachu, surface, mixer, heartthrob, criação de sites, yapp, vnext, mvp" />
...
<body>
    <div id="bodypat">
        <header style="font-size: 54px; font-weight: 300; text-align: center; color: #fff; width: 100%; margin-top: 25px; text-shadow: 4px 4px 10px rgba(0, 0, 0, 0.8);">
          Vítor Norton
        </header>
        <section id="container">
            <div id="loader"></div>
            <section id="mainpage-mos" style="margin-top: -15px">
                <section id="content-mos" class="centered clearfix">
                    ...
                    <a href="#article-1" class="lightbox" rel="section">
                        <div class="tile large live" data-stops="0,20%,80%,100%" data-speed="2000" data-delay="1500" data-direction="horizontal" data-stack="true">
                            <div class="live-front">
                                <img class="live-img" src="images/tile.yapp.png" alt="Y'APP: Descubra aplicativos incríveis" />
                            </div>
                            <div class="live-back">
                                <img class="live-img" src="images/tile.yapp.back.png" alt="Y'APP: Descubra aplicativos incríveis" />
                            </div>
                    ...
                    <div class="tile-pre">
                        <article id="article-1" class="lb-portfolio">
                            <div class="portfolio-img">
                                <img class="tile-pre-img" src="images/tile.yapp.back.png" alt="YAPP" />
                            </div>
                    ...
                    <a href="#article-2" class="lightbox" rel="section">
                        <div class="tile medium live" data-stops="0,75%,100%" data-speed="1500" data-delay="1500">
                            <div class="live-front blue">
                                <img class="live-img" src="images/tile.vnext.png" alt="vNext" />
                            </div>
                            <div class="live-back green">
                                <img class="live-img" src="images/tile.vnext.back.png" alt="vNext" />
                            </div>
                            <span class="tile-cat green">vNext</span>
                        </div>
                    </a>
                    <!-- Lightbox Article Preview -->
                    <div class="tile-pre">
                        <article id="article-2" class="lb-portfolio">
                            <div class="portfolio-img">
                                <img class="tile-pre-img" src="images/tile.vnext.small.png" alt="Yapp" />
                            </div>
                            <div class="lb-port-cont">
                                <h1 class="lb-project"><a href="http://www.vnext.com.br">vNext</a></h1>
                                <div class="lb-desc">
                                    <p>O vNext é um site brasileiro 100% dedicado a todos os produtos da Microsoft voltados ao consumidor e aos desenvolvedores. Aqui você encontra tudo sobre Windows, Xbox, Windowsx, Office, Azure e desenvolvimento. As notícias e conteúdos são abordados com inteligência e humor.</p>
                                    <p><a class="exp-button" href="http://vnext.com.br">Visitar o site &#8594;</a></p>
                                </div>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="tile-pre">
                        <article id="portfolio-1" class="lb-portfolio">
                            ...
                            <div class="lb-port-cont">
                                <h1 class="lb-project"><a href="http://vnext.com.br/nextcast">Nextcast</a></h1>
                                <div class="lb-desc">
                                    ...
                                    <p><a class="exp-button" href="http://vnext.com.br/nextcast">Ouça agora &#8594;</a></p>
                                </div>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="tile-pre">
                        <article id="portfolio-4" class="lb-portfolio">
                            ...
                            <div class="lb-port-cont">
                                <h1 class="lb-project"><a href="https://www.livecoding.tv/vtnorton/">Livecoding.tv</a></h1>
                                <div class="lb-desc">
                    ...
                    <div class="tile-pre">
                        <article id="portfolio-8" class="lb-portfolio">
                            ...
                            <div class="lb-port-cont">
                                <h1 class="lb-project"><a href="https://www.facebook.com/profile.php?id=100011456924177">Facebook: vitor.norton</a></h1>
                                <div class="lb-desc">
                                    ...
                                    <p><a class="exp-button" href="https://www.facebook.com/profile.php?id=100011456924177">Curte lá &#8594;</a></p>
                                </div>
                            </div>
                        </article>
                    </div>
                    ...
                    <!-- Lightbox Article Preview -->
                    <div class="tile-pre">
                        <article id="portfolio-9" class="lb-portfolio">
                            <div class="portfolio-img">
                                <img class="tile-pre-img" src="images/tile.twitter.png" alt="@vt_norton" />
                            </div>
                            <div class="lb-port-cont">
                                <h1 class="lb-project"><a href="#">@vt_norton</a></h1>
                                <div class="lb-desc">
                                    ...
                                    <p><a class="exp-button" href="#">Segue lá! &#8594;</a></p>
                                </div>
                            </div>
                        </article>
                    </div>
