...
namespace AllVtnorton
{
    ...
    {
        public static String Databese = "vtnorton-sql";
        ...
        {
            return "Data Source=axna8xeyyv.database.windows.net;Initial Catalog=vtnorton-sql;Persist Security Info=True;User ID=vtn_db_lg-042@axna8xeyyv;Password=#M1161W4Jm";
        }
    }
}
