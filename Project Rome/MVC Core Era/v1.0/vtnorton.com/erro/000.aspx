<%@ Page Title="Unknow error | Vítor Norton" Language="C#" MasterPageFile="~/healtthrob.Master" AutoEventWireup="true" CodeBehind="000.aspx.cs" Inherits="VTNORTON.erro._000" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section style="margin-top:-50px; padding-bottom:30px">
        <div class="section-image-left flexslider">
            <img class="section-image-left-img" style="padding: 80px; margin-left: 20%; padding-bottom: 40px" src="/erro/000.gif" />
        </div>
        <div class="section-wrapper">
            <div class="section-content-right">
                <h1><%=VTNORTON.Resources.heartthrob.erro000Title %></h1>
                <p><%=VTNORTON.Resources.heartthrob.erro000Description %></p>
            </div>
            <div class="clean"></div>
        </div>
    </section>
