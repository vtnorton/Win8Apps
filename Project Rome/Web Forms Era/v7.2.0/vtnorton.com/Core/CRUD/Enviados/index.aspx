<%@ Page Title="" Language="C#" MasterPageFile="~/Core/Internal.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="VTNORTON.Core.CRUD.Enviados.index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header">
        <h2>E-mails enviados</h2>
        <p><a href="index.aspx">Ver todos</a></p>
            ...
            <ItemTemplate>
                <tr class="dark" id="item<%#Eval("Id") %>">
                    ...
                    <td style="min-width: 108px; max-width: 108px; width: 108px !important">
                        <a href="/Core/CRUD/Enviados/detail.aspx?Id=<%#Eval("Id") %>"><i class="fa fa-share-alt"></i></a>
