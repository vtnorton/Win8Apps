<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="chapter.aspx.cs" Inherits="HidraOnline.p.manage.chapter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        ...
        <li><a class="on" href="/p/manage/chapter.aspx">Gerenciar capítulos</a></li>
