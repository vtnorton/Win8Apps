...
namespace Vtnorton.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ViewData["feedBlog"] = new RSS().GetRSS("http://blog.vtnorton.com/feed", 6).Result;
        ...
        {
            ViewData["title"] = "Grupo de estudos LEGO";
            ViewData["link"] = "https://chat.whatsapp.com/8gRlbdT1Jre9ThXY9L87Do";
            return View("~/Views/Home/Redirecionador.cshtml");
        }
    }
}
