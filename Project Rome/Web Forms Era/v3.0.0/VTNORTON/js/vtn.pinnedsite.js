...
(function (jumplist) {
	...
	var options = {
		...
		siteName: 'vtnorton.com', // Site Name
		applicationName: 'vtnorton.com', // Site Name 
		startURL: '', // Homepage URL 
		shortcutIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/cb3778c4ddcd4bd5b629c20d3b491460/Main-favicon.ico', // Main Site Icon
		tooltip: '',

		// Dynamic jumplist tasks & notifications
		rssFeedURL: 'http://www.buildmypinnedsite.com/RSSFeed?feed=http%3a//vitor.vtnorton.com/feeds/posts/default',
		categoryTitle: '\u00daltimas novidades', // Task group name
		defaultTaskIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/6d4a7e6f84c848b8a9c804cfc864d3cf/GenericTask-blog.ico', // Generic task icon

		navButtonColor: false,

		// Jumplist tasks { name: Task Label, action: Task URL, icon: Task Icon }
		staticTasks: [{ name: 'Acesse nosso blog', action: 'http%3a//vitor.vtnorton.com', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/e80fbddf172049a18efe9d82ca909cfd/Task2-blog.ico', target: 'tab' }, { name: 'Hidra (anteriormente conhecido como Search)', action: 'http%3a//www.vtnorton.com/hidra/index.aspx', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/d1e5e8325dab4cfb827bb212d0196fc2/Task0-Search.ico', target: 'tab' }, { name: 'Tenha seu pr\u00f3prio site', action: 'http%3a//www.vtnorton.com/connect', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/90f384d459f64225bd4e1be561ffeb6b/Task3-connect.ico', target: 'tab' }, { name: 'Conhe\u00e7a o YOLO', action: 'http%3a//www.vtnorton.com/yolo/', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/a3b0020c0d9341d6a43a63e07b5a3ade/Task1-yolo.ico', target: 'tab' }],

		// Drag and drop site pinning bar		
		prompt: true, // Add a site pinning bar on top of my site pages
		barSiteName: 'vtnorton.com' // Site name as it should appear on the pinning bar
	};
