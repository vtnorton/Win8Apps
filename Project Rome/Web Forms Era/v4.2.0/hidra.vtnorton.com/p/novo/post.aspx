...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="right twentyfivepercent">
        ...
        <hr />
        <p>Insira aqui algumas breves configurações como data de publicação, categorias, e publique o seu conteúdo.</p>
        <h5>Opções:</h5>
        <hr />
        ...
        <div class="right">
            ...
            <asp:CheckBox ID="cbxAvabible" Checked="true" Text="Marcar como visível" runat="server" />
        </div>
        <div class="clean"></div>
        <h5>Ao publicar</h5>
        <hr />
        <article>
            <p>Antes de publicar verifique os seguintes pontos para que o post fique de acordo com o padrão Vítor Norton e para que não dê erros inesperados.</p>
            <ul>
        ...
        <br />
        <br />
        <asp:Button ID="btnPublish" OnClick="btnPublish_Click" runat="server" CssClass="full100 btn-green" Height="50" Text="Publicar" />
    </div>
    <div class="clean"></div>
</asp:Content>
