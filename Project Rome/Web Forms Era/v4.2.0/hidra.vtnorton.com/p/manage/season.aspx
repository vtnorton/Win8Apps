<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="season.aspx.cs" Inherits="HidraOnline.p.manage.season" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        ...
        <li><a class="on" href="/p/manage/season.aspx">Gerenciar temporadas</a></li>
