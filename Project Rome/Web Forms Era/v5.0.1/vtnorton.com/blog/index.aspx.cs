...
namespace VTNORTON.blog
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (WithPageIAm == 1)
                lblMorePosts.Text = "<ul><li class='active'><a href='/blog/'>1</a></li>";
            else
                lblMorePosts.Text = "<ul><li><a href='/blog/'>1</a></li>";

            if (WithPageIAm >= 5)
            {
                lblMorePosts.Text += "<li><a href='#'>...</a></li>";
                lblMorePosts.Text += "<li><a href='/blog/?sw=" + ((WithPageIAm - 2) * ItensPorPagina) + "&page=" + (WithPageIAm - 2) + "'>" + (WithPageIAm - 2) + "</a></li>";
                lblMorePosts.Text += "<li><a href='/blog/?sw=" + ((WithPageIAm - 1) * ItensPorPagina) + "&page=" + (WithPageIAm - 1) + "'>" + (WithPageIAm - 1) + "</a></li>";
                ...
                if (WithPageIAm != NumeroDePaginas)
                {
                    ...
                    else if (WithPageIAm == NumeroDePaginas - 3)
                    {
                        lblMorePosts.Text += "<li><a href='/blog/?sw=" + ((WithPageIAm + 1) * ItensPorPagina) + "&page=" + (WithPageIAm + 1) + "'>" + (WithPageIAm + 1) + "</a></li>";
                        lblMorePosts.Text += "<li><a href='/blog/?sw=" + ((WithPageIAm + 2) * ItensPorPagina) + "&page=" + (WithPageIAm + 2) + "'>" + (WithPageIAm + 2) + "</a></li>";
                        lblMorePosts.Text += "<li><a href='/blog/?sw=" + ((NumeroDePaginas - 1) * ItensPorPagina) + "&page=" + NumeroDePaginas + "'>" + NumeroDePaginas + "</a></li>";
                    }
                    else
                    {
                        lblMorePosts.Text += "<li><a href='/blog/?sw=" + ((WithPageIAm + 1) * ItensPorPagina) + "&page=" + (WithPageIAm + 1) + "'>" + (WithPageIAm + 1) + "</a></li>";
            ...
            else
            {
                switch (WithPageIAm)
                {
                    case 1:
                        ...
                        {
                            lblMorePosts.Text += "<li><a href='/blog/?sw=8&page=2'>2</a></li>";
                            lblMorePosts.Text += "<li><a href='/blog/?sw=16&page=3'>3</a></li>";
                            lblMorePosts.Text += "<li><a href='/blog/?sw=24&page=4'>4</a></li>";
                            lblMorePosts.Text += "<li><a href='/blog/?sw=32&page=5'>5</a></li>";
                        }
                        break;
                    case 2:
                        lblMorePosts.Text += "<li class='active'><a href='/blog/?sw=8&page=2'>2</a></li>";
                    ...
                    case 3:
                        lblMorePosts.Text += "<li><a href='/blog/?sw=8&page=2'>2</a></li>";
                        lblMorePosts.Text += "<li class='active'><a href='/blog/?sw=16&page=3'>3</a></li>";
                    ...
                    case 4:
                        lblMorePosts.Text += "<li><a href='/blog/?sw=8&page=2'>2</a></li>";
                        lblMorePosts.Text += "<li><a href='/blog/?sw=16&page=3'>3</a></li>";
                        lblMorePosts.Text += "<li class='active'><a href='/blog/?sw=24&page=4'>4</a></li>";
                ...
                lblMorePosts.Text += "<li><a href='#'>...</a></li>";
                lblMorePosts.Text += "<li><a href='/blog/?sw=" + NumeroDePaginas * ItensPorPagina + "&page=" + NumeroDePaginas + "'>" + NumeroDePaginas + "</a></li>";
            }
