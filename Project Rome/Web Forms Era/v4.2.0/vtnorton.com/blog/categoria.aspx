<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="categoria.aspx.cs" Inherits="VTNORTON.blog.categoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SUBMENU" runat="server">
    <ul>
        ...
        <li>></li>
        <asp:Label ID="lblCategoryNameSubtitle" runat="server" Text=""></asp:Label>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="box-content">
        <asp:Label ID="lblProfileBackground" runat="server" Text="<div>"></asp:Label>
            <div class="left category-pic">
                <asp:Label ID="lblCategoryImage" runat="server" Text=""></asp:Label>
            </div>
            <div class="right category-info">
                <asp:Label ID="lblCategoryName" runat="server" Text=""></asp:Label>
                <p>
                    <asp:Label ID="lblCategoryDescription" runat="server" Text="Label"></asp:Label>
               </p>
                ...
                <ItemTemplate>
                    <div class="lp-stand-alone">
                        ...
                        <div class="right lpsa-post">
                            <h3><a href="/blog/<%#Eval("URL") %>"><%#Eval("Title") %></a></h3>
                            <h6>Data: <%#Eval("PostedDate") %> | Autor: <a href="/blog/author.aspx?id=<%#Eval("IdAuthor") %>"><%#Eval("AuthorName") %></a></h6>
                            <%#Eval("FirstParagraph").ToString() %>
                            <p class="read-more"><a href="/blog/<%#Eval("URL") %>">Leia mais</a></p>
                        </div>
                        <div class="clean"></div>
                    </div>
                </ItemTemplate>
                ...
                <ul>
                    <asp:Repeater ID="Repeater2" runat="server">
                        <ItemTemplate>
                            <li>
                                <p><%#Eval("Title") %></p>
                                <a href="/blog/<%#Eval("URL") %>">Leia mais</a>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
