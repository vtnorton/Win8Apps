<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="edit-production-cost.aspx.cs" Inherits="SunWeb.financial.edit_production_cost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="padding: 20px">
        ...
        <hr />
        <asp:Button ID="btnCadastrar" OnClick="btnCadastrar_Click" runat="server" Text="Editar" />
    </div>
</asp:Content>
